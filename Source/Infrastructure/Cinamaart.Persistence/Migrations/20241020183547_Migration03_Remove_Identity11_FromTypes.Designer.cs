...
namespace Cinamaart.Persistence.Migrations
{
    ...
    [Migration("20241020183547_Migration03_Remove_Identity11_FromTypes")]
    partial class Migration03_Remove_Identity11_FromTypes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.MovieDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("MovieDocumentTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MovieDocumentTypeId");

                    b.HasIndex("MovieId");

                    b.ToTable("MovieDocument", (string)null);
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.SubtitleDocument", b =>
                {
                    ...
                    b.Property<int?>("SubtitleDocumentTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SubtitleDocumentTypeId");
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.TvSerieDocument", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<int?>("TvSeriesDocumentTypeId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("TvSeriesDocumentTypeId");

                    b.ToTable("TvSerieDocument", (string)null);
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Types.MovieDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("MovieDocumentType", (string)null);
                });

            modelBuilder.Entity("Cinamaart.Domain.Entities.Types.SubtitleDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("SubtitleDocumentType", (string)null);
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Types.TvSeriesDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
                    ...
                    b.ToTable("TvSeriesDocumentType", (string)null);
                });

            modelBuilder.Entity("Cinamaart.Domain.Entities.Types.UserDocumentType", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.MovieDocument", b =>
                {
                    b.HasOne("Cinamaart.Domain.Entities.Document", "Document")
                        .WithMany("MovieDocuments")
                        .HasForeignKey("DocumentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Cinamaart.Domain.Entities.Types.MovieDocumentType", "MovieDocumentType")
                        .WithMany("MovieDocuments")
                        .HasForeignKey("MovieDocumentTypeId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("MovieDocumentType");
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.SubtitleDocument", b =>
                {
                    ...
                    b.HasOne("Cinamaart.Domain.Entities.Types.SubtitleDocumentType", "SubtitleDocumentType")
                        .WithMany("SubtitleDocuments")
                        .HasForeignKey("SubtitleDocumentTypeId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("SubtitleDocumentType");
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.TvSerieDocument", b =>
                {
                    ...
                    b.HasOne("Cinamaart.Domain.Entities.Types.TvSeriesDocumentType", "TvSeriesDocumentType")
                        .WithMany("TvSerieDocuments")
                        .HasForeignKey("TvSeriesDocumentTypeId")
                        .OnDelete(DeleteBehavior.SetNull);
                    ...
                    b.Navigation("TvSeriesDocumentType");
                });
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Pivots.UserDocument", b =>
                {
                    ...
                    b.HasOne("Cinamaart.Domain.Entities.Types.UserDocumentType", "UserDocumentType")
                        .WithMany("UserDocuments")
            ...
            modelBuilder.Entity("Cinamaart.Domain.Entities.Document", b =>
                {
                    b.Navigation("MovieDocuments");

                    b.Navigation("SubtitleDocuments");

                    b.Navigation("TvSerieDocuments");
